...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 11:50:40 2019
...
#==============================================================================
#  Note: to replicate the word2vec model results, run lines 66-135.
#  This is computationally and time intensive (5:25:54). To replicate using
#  model outputs from the paper, proceed to line 139 and load pickled model
#  outputs.
#============================================================================== 

start_model = Word2Vec(full_corpus, size = 100, min_count = 0, iter = 200, 
